...
const prayers = [
  ...
  },
  {
    ...
    "amharic_script": "፨ ሁሉም፤ አንድ አምላክ በሆኑ በአብ በወልድ በመንፈስ ቅዱስ ስም ንጹሕ ልዩ ክቡር ጽሩይ በሆኑ",
    "amharic_phonetic": "፨ hulum: and 'amlak behonu be'ab beweld bemenfes ḳdus sm ntsuḥ lyu kbur tsruy behonu",
